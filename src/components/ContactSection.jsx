...
import { contactContent } from '../data/content.js';
			...
			<div className="mx-auto grid w-full gap-12 px-16 md:grid-cols-[1.1fr_1fr] md:items-start lg:px-32">
				<div className="flex flex-col gap-7 rounded-[36px] border border-[#1F3A68]/15 bg-white p-10 shadow-xl shadow-[#1F3A68]/10">
					<div className="space-y-5">
						...
						<h2 className="text-4xl font-semibold text-[#1F3A68]">{contactContent.heading}</h2>
						<p className="text-lg text-[#1F3A68]/75">{contactContent.description}</p>
					</div>
					<ul className="space-y-4 text-base text-[#1F3A68]/75">
						<li className="flex items-center gap-3">
							...
							<span className="font-semibold text-[#1F3A68]">{contactContent.email}</span>
						</li>
						<li className="flex items-center gap-3">
							...
							<span className="font-semibold text-[#1F3A68]">{contactContent.phone}</span>
						</li>
					</ul>
